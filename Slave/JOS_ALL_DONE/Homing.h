...
// ==================== PIN DEFINITIONS ====================
#define HOMING_SENSOR_KIRI PA4
#define HOMING_SENSOR_KANAN PA5
...
#define HOMING_SENSOR_HIGH 1000  //950
#define HOMING_SENSOR_LOW 400    //450

// ==================== ARAH KONSTANTA ====================
#define ARAH_HOME 1      // Kiri HIGH, Kanan LOW -> SUDAH HOME
#define ARAH_KE_KIRI 2   // Kedua HIGH -> Magnet di kiri -> Putar Kanan
#define ARAH_KE_KANAN 3  // Kedua LOW  -> Magnet di Kanan  -> Putar Kiri
 ...
 * >= 1000        >= 1000         MAGNET DI SEBELAH kiri PUTAR Kanan
 * <= 400        <= 400         MAGNET DI SEBELAH kanan  PUTAR kiri
 * 
...
int homing_checkPosition() {
  ...
  Serial.print("49eKiri = ");
  Serial.print(kiri);
  Serial.print("      ");
  Serial.print("49ekanan = ");
  Serial.println(kanan);

  // Kondisi 1: Kiri HIGH, Kanan LOW = HOME
  if (kiri >= HOMING_SENSOR_HIGH && kanan <= HOMING_SENSOR_LOW) {
    return ARAH_HOME;
  }
    ...
    if (serialMutex != NULL) {
      ...
      switch (pos) {
        case ARAH_HOME:
          ...
          break;
        case ARAH_KE_KIRI:
          Serial.println("Magnet di KANAN -> Putar KIRI (Keduanya LOW)");
          break;
        case ARAH_KE_KANAN:
          Serial.println("Magnet di KIRI -> Putar KANAN (Keduanya HIGH)");
          break;
        default:
