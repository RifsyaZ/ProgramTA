...
void parseCommand(String cmd) {
  ...
  // Format: 1:45:20 (RS485 style via USB)
...
// ==================== GUI OUTPUT TASK (UNTUK PYTHON GUI) ====================
void sendGuiData() {
  // Format yang diharapkan GUI: ID:angle,rpm,pwm_pos,pwm_spd,ready
  // Contoh: 1:45.5,30.2,50,120,1
...
void guiOutputTask(void *pvParameters) {
  ...
  const TickType_t xFrequency = pdMS_TO_TICKS(50);  // Kirim setiap 50ms (20Hz)
